      ...
      <div className="relative group/arrow">
        <div className="flex items-center">
          <p
            ...
            className="group/title flex flex-row text-gray-300 hover:text-gray-50 text-md md:text-xl lg:text-2xl font-semibold pt-4 pb-4 cursor-pointer z-20"
          >
            {title}

            <span className="hidden group-hover/title:block animate-slide-in-left ml-4 mt-2 text-cyan-400 xs:text-xs md:text-sm xl:text-base z-20 hover:text-cyan-300">
              Explore All
            </span>
